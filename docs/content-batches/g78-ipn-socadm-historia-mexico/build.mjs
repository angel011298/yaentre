// Construye los 6 archivos JSON del lote G78 (uno por tema de Historia de
// México, IPN SOCADM) a partir de build-data.mjs. La posición de la
...
for (const item of ITEMS) {
  ...
  const draft = {
    ...
    explanations: [
      { layer: 1, title: 'La causa clave', content: item.layer1 },
...
const TOPIC_FILE_NAMES = [
  '1-epoca-prehispanica.json',
  '2-conquista-colonia.json',
  '3-independencia.json',
  '4-reforma-intervencion.json',
  '5-revolucion-mexicana.json',
  '6-mexico-moderno.json',
];
